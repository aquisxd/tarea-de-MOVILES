      ...
      body: Container(
        child: Column(
          children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    DropdownButton<String>(
                      dropdownColor: Color.fromARGB(255, 7, 106, 187),
                      isDense: true,
                      isExpanded: false,
                      iconEnabledColor: Color.fromARGB(255, 1, 38, 139),
                      focusColor: Color.fromARGB(255, 2, 33, 117),
                ...
                Row(
                  children: [
                    Text('Grupo : '),
                    DropdownButton<String>(
                      dropdownColor: Color.fromARGB(255, 9, 90, 182),
                      isDense: true,
                      isExpanded: false,
            ...
            MaterialButton(
              color: Color.fromARGB(255, 9, 90, 182),
